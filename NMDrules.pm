...
=head1 DESCRIPTION 
 ...
 This is a plugin for the Ensembl Variant Effect Predictor (VEP) that predicts whether a stop gained variant triggers nonsense-mediated 
 ...
 The plugin also shows the 2 codons/aminoacids before the novel stop codons, and the next nucleotide for futher analysis, as they may influence the NMD efficiency (2):
 ...
 The plugin has been applied to all the gnomAD v2.1 variants without throwing any errors. Beware that more complex variants may trigger novel errors.
 ...
 (2) Advanced variant classification framework reduces the false positive rate of predicted loss-of-function variants in population sequencing data (Singer-Berk et al. 2023, Am J Hum Genet)
 (3) Systematic analysis of nonsense variants uncovers peptide release rate as a novel modifier of nonsense-mediated mRNA decay efficiency (Kolokada et al. 2024, bioRxiv)
