...
This plugin has been tested on all the gnomAD 2.1.1 exomes variants without throwing any errors. Be aware that more complex variants may cause unobserved bugs.
